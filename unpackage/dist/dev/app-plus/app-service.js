...
(function(vue) {
  ...
  const _sfc_main$1 = {
    ...
    setup(__props) {
      ...
      const code2 = vue.ref("");
      const start = () => {
        const KeepAlive = requireNativePlugin("Keep_Alive");
        KeepAlive.start(
          {
            "title": "app",
            "text": "正在后台运行"
          ...
          function(ret) {
            formatAppLog("log", "at pages/module/module.vue:28", ret);
            if (ret.code == 1) {
              uni.showToast({
                title: "启动成功",
                icon: "none"
        ...
        return vue.openBlock(), vue.createElementBlock(
          ...
          [
            vue.createElementVNode(
              "view",
              { style: { "font-size": "20px", "color": "#bfa" } },
              vue.toDisplayString(msg.value) + " " + vue.toDisplayString(code2.value),
              1
              /* TEXT */
            ),
            vue.createElementVNode("button", { onClick: start }, "开始服务"),
            vue.createElementVNode("button", { onClick: stop }, "结束服务")
          ],
          64
          /* STABLE_FRAGMENT */
        );
  ...
  const PagesModuleModule = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["__file", "D:/project/uniapp/uni-module/pages/module/module.vue"]]);
  __definePage("pages/module/module", PagesModuleModule);
  const _sfc_main = {
    onLaunch: function() {
      if (!uni.getStorageSync("user") && !uni.getStorageSync("isLogin")) {
        uni.redirectTo({
  ...
  const App = /* @__PURE__ */ _export_sfc(_sfc_main, [["__file", "D:/project/uniapp/uni-module/App.vue"]]);
  const mixin = {
    data() {
      return {};
    },
